        ...
        <section className="container" id="about">
            ...
            <div className="row">
                <div className="col-lg-6">
                    <p className="text-justify">I am Mohammad Mahbubul Alam. I describe myself as a passionate developer and SQA engineer who loves coding and testing. At present, I am seeking a challenging and rewarding position as a Software Quality Assurance Engineer, with a strong will to prosper in any assigned duties.</p>
