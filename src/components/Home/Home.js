                ...
                <div className="row pt-5 pb-4"> 
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 text-white d-flex align-items-center">
                        <div>
                            ...
                            <a role="button" class="btn-color-one text-decoration-none" href="https://drive.google.com/file/d/1kZlyphVS2p-LFJ-SZXT_QZBS972YzRZA/view?usp=sharing" target="_blank" download>Download Resume</a>
