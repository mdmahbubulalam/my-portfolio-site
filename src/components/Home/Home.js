                ...
                <div className="row pt-5 pb-4"> 
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 text-white d-flex align-items-center">
                        <div>
                            ...
                            <a role="button" class="btn-color-one text-decoration-none" href="https://drive.google.com/file/d/1ith1S4aTNPf56JI05DwH5J4-V9pp__n_/view?usp=share_link" target="_blank">Download Resume</a>
